  ...
  <div class="flex flex-col mt-20">
    <div class="main-grid">
      <div class="post-header">
        ...
        <div class="flex flex-row items-center justify-start flex-wrap gap-4 mt-8 mb-4">
          <div
            class="post-footer"
            v-if="post.author"
          >
...
export default defineComponent({
  ...
  setup() {
    ...
    const avatarSrc = computed(() => {
      if (post.value.author && post.value.author.avatar) {
        return post.value.author.avatar
      }
